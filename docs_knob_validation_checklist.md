...
3. Compare `total_swept_forgotten` (and optionally `sweep_points`) at same `tau_final`.

Expected wiring signal: higher lambda should increase swept-forgotten counts over the same run.
