...
def test_clock_rate_monotonic_and_floor():
    ...
    # psi > 1 clamps to 1.0 → identical rate
    assert modulator.clock_rate_from_psi(1e6) == modulator.clock_rate_from_psi(1.0)


def test_clock_chronology_is_canonical():
